...
export function TileCard({
  ...
  return (
    <Link
      ...
      className="glass-panel grid-glow group relative flex min-h-[220px] flex-col justify-between rounded-[28px] border border-white/10 p-6 transition duration-300 hover:-translate-y-1.5 hover:border-cyan-300/35 hover:bg-white/10"
    >
      <div
